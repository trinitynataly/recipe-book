    ...
    authenticate(req, res, async () => {
        if (method === 'POST') {
            try {
                ...
                const existingFavorite = await Favorite.findOne({ userID: req.user._id, recipeID: recipe._id });
                if (existingFavorite) {
                    ...
                    const newFavorite = new Favorite({ userID: req.user._id, recipeID: recipe._id });
