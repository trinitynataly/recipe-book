 ...
 * @param {string} endpoint - the API endpoint to call, e.g., 'recipes'
 * @param {string} method - the HTTP method to use (default is GET)
 * @param {object} data - the data to send with the request (default is null)
 * @param {object} context - the context object from getServerSideProps (default is null)
 * @returns {Promise<any|{success: boolean, message: (*|string)}>}
 */
